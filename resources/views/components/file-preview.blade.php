...
<div class="mb-3 max-w-[95%]">
    @if($type === 'image')
        @if($file instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile)
            <img src="{{ $file->temporaryUrl() }}" alt="logo" class="w-50 h-auto object-contain" loading="lazy">
        @elseif($form_file != null)
            <img src="{{ $form_file }}" alt="logo" class="w-50 h-auto object-contain" loading="lazy">
        @endif

    @elseif($type === 'video')
        @if($file instanceof \Livewire\Features\SupportFileUploads\TemporaryUploadedFile)
            <video controls class="w-50 h-auto object-contain">
