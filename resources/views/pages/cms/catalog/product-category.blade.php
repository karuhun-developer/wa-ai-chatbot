...
name('cms.catalog.product-category');

// Page title and breadcrumbs
render(function (View $view) {
    // Page title and breadcrumbs
    $title = 'Product Categories';
    $description = 'Manage the product categories for your catalog. Create, update, and organize categories to keep your products well-structured.';
    $breadcrumbs = [
        [
            'label' => 'Catalog',
            'url' => '#'
...
<x-layouts.app :$title>
    <div class="w-full">
        ...
        <livewire:cms.catalog.product-category.table />
    </div>
</x-layouts.app>
